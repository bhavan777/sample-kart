...
A login/logout button as short cut to login and logout of account. Details are static.
The cart has only 4 static products as content.
Payment success is assumed on clicking proceed to payment button on cart.
